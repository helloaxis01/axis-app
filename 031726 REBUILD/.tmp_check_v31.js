...
const obDarkVars = `
  ...
  --ob-accent:#FF9F43; --ob-accent-text:#0a0e1a; --ob-accent-dim:rgba(255,159,67,0.18); --ob-accent-glow:rgba(255,159,67,0.30);
...
const OB_GREY = {
  dark: {
    ...
    accentBtnText: "#0f0f12", textPrimary: "#f4f4f5", tabBg: "rgba(8,12,20,0.90)"
  },
  light: {
...
const css = `
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .app[data-theme="dark"] {
    ...
    --text-secondary: rgba(246,247,248,0.75);
    --text-dimmer: rgba(246,247,248,0.32);
    --glass-bg: rgba(246,247,248,0.06);
    --glass-border: rgba(246,247,248,0.12);
  }
  .app[data-theme="light"] {
    --text-white: var(--axis-black);
    --text-secondary: rgba(37,37,37,0.75);
    --text-dimmer: rgba(37,37,37,0.32);
  ...
  [data-theme="light"] {
    ...
    /* Tab bar: opaque enough to separate from lavender gradient (Safari/iOS frosted read) */
    --tab-bg: rgba(252, 253, 255, 0.94);
  ...
  /* Must use .app[data-night="true"] (same specificity as .app[data-theme="dark"]) or
     Safari keeps --text-white from dark theme (#f6f7f8) and headers read as white. */
  .app[data-night="true"] {
    --bg-gradient: #000000;
    --orb1: none; --orb2: none; --orb3: none;
    --glass-bg: #000000;
    --glass-bg-hover: #000000;
    --glass-border: #FF0000;
    --glass-border-strong: #FF0000;
    --glass-specular: #000000;
    --glass-shadow: none;
    ...
    --accent-glow: #000000;
    --cue-bar: #FF0000;
    --cue-bar-label: #FF0000;
    --border: #FF0000;
    --border-card: #FF0000;
    --text-done: #FF0000;
    --dot-bg: #000000;
    --dot-done: #FF0000;
    --step-connector: #FF0000;
  ...
  /* WebKit: explicit red ink on session chrome (var(--text-white) can still resolve wrong) */
  ...
  /* LIST: divider lines only (not a red box per row) — match Chromium session list */
  ...
  [data-night="true"] .tab-bar-wrap { background: #000000 !important; }
  [data-night="true"] .tab-bar,
  [data-night="true"] .tab-bar--liquid {
    background: #000000 !important;
    border-top: 1px solid #FF0000 !important;
    border-color: #FF0000 !important;
    box-shadow: none !important;
  }
  [data-night="true"] .tab-bar-wrap--scroll-end .tab-bar,
  [data-night="true"] .tab-bar-wrap--scroll-end .tab-bar--liquid {
    background: #000000 !important;
  }
  [data-night="true"] .tab-bar-spacer { background: #000000 !important; border: none !important; }
  [data-night="true"] .tab-subbar { box-shadow: none !important; border-top: 1px solid #FF0000 !important; }
  [data-night="true"] .track-card,
  [data-night="true"] .er,
  [data-night="true"] .panel,
  [data-night="true"] .sg { background: #000000 !important; border-color: #FF0000 !important; }
  [data-night="true"] .track-card::before,
  [data-night="true"] .glass-card::before { background: #000000 !important; }
  [data-night="true"] .tab-bar .tab-bar-top-line { display: none !important; }
  .tab-bar[data-night="true"] .tab-btn.active { color: #FF0000 !important; --tab-active-fill: #FF0000; }
  .tab-bar[data-night="true"] .tab-btn { color: rgba(255,0,0,0.25) !important; }
  .tab-bar[data-night="true"] .tab-btn:hover { color: rgba(255,0,0,0.25) !important; }
  .tab-bar[data-night="true"] .tab-btn.active:hover { color: #FF0000 !important; }
  /* Ensure no halo behind active icon */
  ...
  [data-night="true"] .prog-fill { background: #FF0000 !important; box-shadow: none !important; }
  [data-night="true"] .prog-bar { background: #000000 !important; border: 1px solid #FF0000 !important; }
  [data-night="true"] .fav-toggle { background: #000000 !important; border-color: #FF0000 !important; }
  [data-night="true"] .fav-toggle.on { background: #000000 !important; border-color: #FF0000 !important; color: #FF0000 !important; }
  [data-night="true"] .chk { background: #000000 !important; border-color: #FF0000 !important; }
  [data-night="true"] .chk.on { background: #FF0000 !important; border-color: #FF0000 !important; }
  [data-night="true"] .hdr-dur { background: #000000 !important; border-color: #FF0000 !important; }
  [data-night="true"] .tab { color: #FF0000 !important; }
  [data-night="true"] .tab.on { color: #FF0000 !important; }
  [data-night="true"] .tab.on::after { background: #FF0000 !important; }
  [data-night="true"] .purpose-note { background: #000000 !important; border-color: #FF0000 !important; }
  [data-night="true"] .start-here-group {
    background: #FF0000 !important;
    border: 2px solid #FF0000 !important;
    box-shadow: none !important;
  }
  /* TODAY hero: black copy on red (not .app red inherit); CTA black + red label — do not use * (conflicts with .begin-btn below) */
  .app[data-night="true"] .start-here-group > div {
    color: #000000 !important;
    -webkit-text-fill-color: #000000;
  }
  .app[data-night="true"] .start-here-group .begin-btn--today-primary {
    background: #000000 !important;
    color: #FF0000 !important;
    -webkit-text-fill-color: #FF0000 !important;
  ...
  /* Exclude .start-here-group — it also has .track-group; transparent would hide the red TODAY hero */
  [data-night="true"] .track-group:not(.start-here-group) {
    background: transparent !important;
    border: none !important;
    box-shadow: none !important;
  }
  [data-night="true"] .track-group-label,
  [data-night="true"] .track-card-name,
  [data-night="true"] .track-card-purpose,
  [data-night="true"] .track-card-dur,
  ...
  /* Timer: avoid .timer-view-body * { color: red } — it makes red-on-red on primary CTAs in WebKit */
  [data-night="true"] .timer-view-body .timer-glass-btn-pri {
    background: #FF0000 !important;
    border: none !important;
    color: #000000 !important;
    -webkit-text-fill-color: #000000 !important;
  ...
  [data-night="true"] .timer-view-body .timer-glass-toggle-btn {
    background: #000000 !important;
    border: 1px solid #FF0000 !important;
    color: #FF0000 !important;
    -webkit-text-fill-color: #FF0000 !important;
  ...
  [data-night="true"] .app-page-header,
  [data-night="true"] .app-page-header * {
    color: #FF0000 !important;
  }
  /* Session screens: force all copy and strokes to red */
  [data-night="true"] .hdr-wrap,
  [data-night="true"] .tab-subbar,
  ...
  [data-night="true"] .panel,
  [data-night="true"] .fc,
  [data-night="true"] .fv-main,
  [data-night="true"] .fv-bar,
  [data-night="true"] .rest-overlay,
  [data-night="true"] .summary,
  [data-night="true"] .summary-cell {
    color: #FF0000 !important;
    border-color: #FF0000 !important;
    stroke: #FF0000 !important;
  }
  /* Black ink on red accent fills (overrides .content * / .fv-main session red above) */
  ...
  [data-night="true"] .content svg,
  [data-night="true"] .content svg *,
  [data-night="true"] .fv-overlay svg,
  [data-night="true"] .fv-overlay svg * {
    stroke: #FF0000 !important;
  }
  /* ── BASE ── */
  ...
  .content.content--session { padding-bottom: 12px; }
  .sg {
    margin-top:32px;
    background:var(--glass-bg);
  ...
  .session-card.track-card {
    ...
    background: linear-gradient(135deg, rgba(255, 255, 255, 0.05), rgba(255, 255, 255, 0.01)), var(--glass-bg);
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.08), 0 24px 48px rgba(0,0,0,0.06), var(--glass-shadow);
  }
  ...
  .session-card.track-card:hover {
    background: linear-gradient(135deg, rgba(255, 255, 255, 0.06), rgba(255, 255, 255, 0.02)), var(--glass-bg-hover);
  }
  .protocol-panel.panel {
    ...
    border-top: 1px solid rgba(255, 255, 255, 0.12);
    background: linear-gradient(135deg, rgba(255, 255, 255, 0.05), rgba(255, 255, 255, 0.01)), var(--glass-bg);
    box-shadow: 0 4px 20px rgba(60,80,150,0.10), inset 0 1px 0 rgba(255, 255, 255, 0.1);
  }
  .today-card {
    transition: background var(--motion-slow), border-color var(--motion-slow), box-shadow var(--motion-slow), transform var(--motion-slow), backdrop-filter var(--motion-slow);
  }
  .panel:focus { outline: none; }
  .panel:focus-visible { outline: 2px solid var(--accent); outline-offset: 3px; }
  [data-theme="dark"] .panel {
    background: linear-gradient(135deg, rgba(255, 255, 255, 0.05), rgba(255, 255, 255, 0.01)), rgba(0,0,0,0.32);
    box-shadow:0 4px 24px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.12);
  }
  [data-theme="light"] .panel {
    background: linear-gradient(135deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.04)), rgba(0,0,0,0.06);
  ...
  /* ── FAV FILTER ── */
  .fav-filter { display:flex; align-items:center; gap:8px; padding:14px 0 6px; flex-wrap:nowrap; white-space:nowrap; overflow:hidden; }
  .fav-toggle {
    padding:2px 8px; border-radius:20px; font-family:'Barlow',sans-serif;
  ...
  .tab-btn {
    ...
    transition:color 0.15s; position:relative; flex:0 0 auto;
  }
  .tab-btn.active { color:var(--accent); }
  .tab-btn:hover { color:#d9e7ff; }
  .tab-icon-shell {
    position:relative; display:flex; align-items:center; justify-content:center;
    width:30px; height:30px;
  }
  .tab-btn svg { stroke:currentColor; fill:none; transition:all 0.15s; width:30px; height:30px; }
  .tab-btn.active .tab-icon-shell::before {
    content:""; position:absolute; left:50%; top:50%;
    width:24px; height:24px; transform:translate(-50%,-50%);
    border-radius:50%;
    background: radial-gradient(circle at center, var(--accent) 0%, var(--accent-dim) 45%, transparent 70%);
  ...
  .tab-bar-spacer {
    height: calc(var(--axis-bottom-content-inset) + var(--axis-tab-clearance) + var(--axis-tab-h) + env(safe-area-inset-bottom, 0px));
  }

  /* Active SESSION (LIST / GUIDED / SUMMARY): tight tail above tab bar */
  .tab-bar-spacer--session {
    height: calc(var(--axis-tab-clearance) + var(--axis-tab-h) + env(safe-area-inset-bottom, 0px) + 12px);
    min-height: 0;
  }

  /* Light mode: tab bar must read as a distinct strip (not “white on white”); icons use dark ink */
  .tab-bar[data-theme="light"] {
    background: var(--tab-bg);
    border-top: 1px solid rgba(100, 130, 175, 0.38);
    box-shadow: 0 -6px 28px rgba(15, 35, 70, 0.1), 0 -1px 0 rgba(255, 255, 255, 0.85) inset;
    backdrop-filter: blur(20px) saturate(1.12);
    -webkit-backdrop-filter: blur(20px) saturate(1.12);
  }
  .tab-bar[data-theme="light"] .tab-btn {
    color: rgba(15, 30, 46, 0.42);
  }
  .tab-bar[data-theme="light"] .tab-btn:hover {
    color: rgba(15, 30, 46, 0.62);
  }
  .tab-bar[data-theme="light"] .tab-btn.active {
    color: var(--accent);
  }
  .tab-bar[data-theme="light"] .tab-btn.active .tab-icon-shell::before {
    filter: blur(8px);
...
function Steps({ steps, small, start: startText, demoVideo }) {
  ...
  return (/*#__PURE__*/
    ...
    !small && /*#__PURE__*/
    React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 12px", borderBottom: "1px solid var(--border)" } }, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: 13, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "inherit" } }, "INSTRUCTIONS"), /*#__PURE__*/
    React.createElement("button", { onClick: () => setCollapsed((c) => !c), style: { background: "transparent", border: nightMode ? "1px solid #FF0000" : "none", color: "inherit", cursor: "pointer", fontWeight: 700 } },
    collapsed ? "Show" : "Hide"
    )
    ),

    small && (steps?.length > 0 || startText) && /*#__PURE__*/
    React.createElement("div", { style: { display: "none", fontSize: 9, letterSpacing: "0.22em", textTransform: "uppercase",
    ...
    !collapsed && small && demoVideo && /*#__PURE__*/
    React.createElement("div", { style: { padding: "10px 16px 8px", textAlign: "center", borderBottom: steps?.length ? "1px solid var(--border)" : "none", marginBottom: 6 } }, /*#__PURE__*/
    React.createElement(VideoDemo, {
      src: demoVideo,
    ...
    !collapsed && startText && (small ? /*#__PURE__*/
    React.createElement("div", { className: "step" }, /*#__PURE__*/
    React.createElement("div", { className: "step-right" }, /*#__PURE__*/
    React.createElement("div", { className: "step-focus", style: { marginBottom: 4 } }, "Start"), /*#__PURE__*/
    React.createElement("div", { className: "step-cue" }, startText)
    )
    ) : /*#__PURE__*/

    React.createElement("div", { className: "fc-step" }, /*#__PURE__*/
    React.createElement("div", { className: "fc-right" }, /*#__PURE__*/
    React.createElement("div", { className: "fc-pfocus" }, "Start"), /*#__PURE__*/
    React.createElement("div", { className: "fc-pcue" }, startText)
    )
    )),
    ...
    React.createElement("div", { className: "step-badge" }, /*#__PURE__*/
    React.createElement("div", { className: "step-badge-inner" }, /*#__PURE__*/
    React.createElement("span", { className: "step-pos" }, i + 1)
    )
    ), /*#__PURE__*/
    React.createElement("div", { className: "step-right" }, /*#__PURE__*/
    React.createElement("div", { className: "step-focus" }, s.focus || (i === 0 ? "Setup" : "Move")), /*#__PURE__*/
    React.createElement("div", { className: "step-cue" }, s.cue)
    )
    ) : /*#__PURE__*/

    React.createElement("div", { className: "fc-step", key: i }, /*#__PURE__*/
    React.createElement("div", { className: "fc-badge" }, /*#__PURE__*/
    React.createElement("span", { className: "fc-pos" }, i + 1)
    ), /*#__PURE__*/
    React.createElement("div", { className: "fc-right" }, /*#__PURE__*/
    React.createElement("div", { className: "fc-pfocus" }, s.focus || (i === 0 ? "Setup" : "Move")), /*#__PURE__*/
...
function ExRow({ ex, done, onToggle, open, onExpand, skipped, onSkip, faved, onFav, note, onNote, nextName, hideTimer = false, hideDone = false, exerciseDurationSeconds }) {
  ...
  return (/*#__PURE__*/
    ...
    open && /*#__PURE__*/
    React.createElement("div", { className: "panel protocol-panel", style: skipped ? { opacity: 0.45 } : {} }, /*#__PURE__*/
    ...
    React.createElement("button", { className: "mark-btn", onClick: (e) => {e.stopPropagation();markDoneAndCollapse();} }, "Mark Done")
    ) :
    ex.reps && (ex.id === 5 || ex.id === 702) && !hideDone ? /*#__PURE__*/
    React.createElement("button", { className: "mark-btn", onClick: (e) => {e.stopPropagation();markDoneAndCollapse();}, style: { marginTop: 16 } }, "Mark Done") :
    !hideDone ? /*#__PURE__*/React.createElement("button", { className: "mark-btn", onClick: (e) => {e.stopPropagation();markDoneAndCollapse();}, style: { marginTop: 16 } }, "Mark Done") : null
...
function TabBar({ view, setView, hasActiveSession, theme, nightMode = false }) {
  ...
  const HomeIcon = () => /*#__PURE__*/React.createElement("svg", { width: "30", height: "30", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round" }, /*#__PURE__*/React.createElement("path", { d: "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" }), /*#__PURE__*/React.createElement("polyline", { points: "9 22 9 12 15 12 15 22" }));
  const SessionIcon = () => /*#__PURE__*/React.createElement("svg", { width: "30", height: "30", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round" }, /*#__PURE__*/React.createElement("circle", { cx: "12", cy: "12", r: "10" }), /*#__PURE__*/React.createElement("polyline", { points: "8 12 11 15 16 9" }));
  ...
  const TimerIcon = () => /*#__PURE__*/React.createElement("svg", { width: "30", height: "30", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round" }, /*#__PURE__*/React.createElement("circle", { cx: "12", cy: "12", r: "10" }), /*#__PURE__*/React.createElement("line", { x1: "12", y1: "12", x2: "12", y2: "8" }), /*#__PURE__*/React.createElement("line", { x1: "12", y1: "12", x2: "16.5", y2: "12" }));
  ...
  const bar = /*#__PURE__*/
  React.createElement("div", { className: "tab-bar", "data-theme": theme, "data-night": nightMode ? "true" : "false" }, /*#__PURE__*/
  ...
  React.createElement("span", { className: "tab-icon-shell" }, /*#__PURE__*/React.createElement(HomeIcon, null))
  ...
  React.createElement("span", { className: "tab-icon-shell" }, /*#__PURE__*/React.createElement(SessionIcon, null))
  ...
  React.createElement("span", { className: "tab-icon-shell" }, /*#__PURE__*/React.createElement(TimerIcon, null))
  ...
  React.createElement("span", { className: "tab-icon-shell" }, /*#__PURE__*/React.createElement(MoodIcon, null))
  ...
  React.createElement("span", { className: "tab-icon-shell" }, /*#__PURE__*/React.createElement(SettingsIcon, null))
...
function OverlayTimer({ seconds, onDone, autoStart = false, paused = false, onReset, fi = 0, list = [], theme = "dark", activePeriod = null, nightMode = false, large = false, compactBarGap = false }) {
  ...
  { accent: "#FF0000", accentDim: "#FF0000" } :
  ...
  const TN = nightMode ? "#FF0000" : isTimerDark ? "#ffffff" : "#1a1048";
  const TU = nightMode ? "#FF0000" : isTimerDark ? "rgba(232,228,223,0.45)" : "rgba(26,16,72,0.55)";
  const TC = nightMode ? "#FF0000" : isTimerDark ? "rgba(232,228,223,0.50)" : "rgba(26,16,72,0.55)";
  const TCB = nightMode ? "#FF0000" : isTimerDark ? "#ffffff" : "#1a1048";
  const BAR_TRACK = nightMode ? "#FF0000" : isTimerDark ? "rgba(255,255,255,0.10)" : "rgba(15,30,46,0.10)";
  const BAR_FILL = `linear-gradient(90deg,${timerAccent},${timerAccentDim})`;
  const DOT_CURR = nightMode ? "#FF0000" : isTimerDark ? "#ffffff" : "#0f1e2e";
  const DOT_DONE = timerAccent;
  const DOT_REST = nightMode ? "#FF0000" : isTimerDark ? "rgba(255,255,255,0.18)" : "rgba(15,30,46,0.15)";
  const LINE_DONE = `${timerAccent}44`;
  const LINE_REST = nightMode ? "#FF0000" : isTimerDark ? "rgba(255,255,255,0.08)" : "rgba(15,30,46,0.10)";
  const NEXT_C = nightMode ? "#FF0000" : isTimerDark ? "rgba(232,228,223,0.40)" : "rgba(15,30,46,0.50)";
  const NEXT_NAME = nightMode ? "#FF0000" : isTimerDark ? "rgba(232,228,223,0.70)" : "#0f1e2e";
  ...
  const displayColor = nightMode ? "#FF0000" : isTimerDark ? "#ffffff" : "#1a1048";
  return (/*#__PURE__*/
    ...
    React.createElement("div", { style: { minWidth: 100, textAlign: "left", fontVariantNumeric: "tabular-nums", fontFamily: "'Barlow', sans-serif", fontSize: numSize, fontWeight: 600, letterSpacing: "-0.04em", color: displayColor, lineHeight: 1 } }, display)
    ), /*#__PURE__*/
...
function GuidedOverlay({ theme, activePeriod, activeAll: activeAllProp, TOTAL, done, totalDone, sessionSecs,
  ...
  const W = isNight ? "#FF0000" : ct.textPrimary || (isDark ? "#ffffff" : "#0f1020");
  const S = isNight ? "#FF0000" : isDark ? "rgba(232,228,223,0.60)" : ct.textPrimary ? ct.textPrimary + "cc" : "rgba(15,30,46,0.75)";
  const D = isNight ? "#FF0000" : isDark ? "rgba(232,228,223,0.35)" : ct.textPrimary ? ct.textPrimary + "88" : "rgba(15,30,46,0.50)";
  ...
  const CARD_BDR = isNight ? "#FF0000" : isDark ? `${ct.accent}33` : `${ct.accent}44`;
  const BTN_BG = isNight ? "#000000" : isDark ? "rgba(255,255,255,0.09)" : "rgba(255,255,255,0.65)";
  const BTN_BDR = isNight ? "#FF0000" : isDark ? `${ct.accent}55` : `${ct.accent}66`;
  ...
  const CUE_COLOR = W;
  const NAME_DIM = D;
  const HAIRLINE = isNight ? "#FF0000" : isDark ? "rgba(255,255,255,0.07)" : `${ct.accent}22`;
  ...
  const GLASS_BDR = isNight ? "1px solid #FF0000" :
  ...
  const BAR_BDR = isNight ? "1px solid #FF0000" :
  ...
  const DIVIDER = isNight ? "1px solid #FF0000" :
  isDark ? "1px solid rgba(255,255,255,0.08)" : "1px solid rgba(0,0,0,0.06)";
  const ROW_DIV = isNight ? "1px solid #FF0000" :
  ...
  const BACK_DIM = isNight ? "#FF0000" : isDark ? "rgba(255,255,255,0.22)" : "rgba(15,30,46,0.22)";
  ...
  const list = Array.isArray(activeAllProp) ? activeAllProp : [];
  ...
  if (listTotal === 0 || !cur) {
    return (/*#__PURE__*/
      React.createElement("div", { className: "guided-overlay", "data-theme": theme, "data-night": isNight ? "true" : "false", style: {
      ...
      React.createElement("div", { style: { fontSize: 18, fontWeight: 600, marginBottom: 12, color: W } }, "No exercises in this flow"), /*#__PURE__*/
      React.createElement("div", { style: { fontSize: 14, color: S, marginBottom: 24 } }, "Add exercises or clear filters and try again."), /*#__PURE__*/
      React.createElement("button", { className: isNight ? "guided-cta-fill" : undefined, onClick: onExit, style: {
          padding: "14px 40px", borderRadius: 28, cursor: "pointer",
          background: A, border: nightMode ? "1px solid #FF0000" : "none", color: isNight ? "#000000" : "#ffffff",
          WebkitTextFillColor: isNight ? "#000000" : undefined,
  ...
  return (/*#__PURE__*/
    React.createElement("div", { className: "guided-overlay", "data-theme": theme, "data-night": isNight ? "true" : "false", "data-phase": phase, style: {
        position: "fixed", top: 0, left: 0, right: 0, bottom: 0, zIndex: 99999,
    ...
    (!isExercisePhase || isNight) && /*#__PURE__*/
    ...
    phase !== "intro" && phase !== "closing" && listTotal > 0 && /*#__PURE__*/React.createElement("div", { style: {
        fontSize: 11, fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase",
        color: S, fontFamily: "'Barlow', sans-serif"
      } }, fi + 1, "/", listTotal),
    phase !== "intro" && phase !== "closing" && phase !== "milestone" && /*#__PURE__*/React.createElement("div", { style: {
        fontSize: 10, fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase",
        color: S, fontFamily: "'Barlow', sans-serif", opacity: 0.95
      } }, phase === "getready" ? "REST & GET READY" : "BEGIN")
    ), /*#__PURE__*/
    React.createElement("button", { onClick: onExit, style: {
        display: "flex", alignItems: "center", justifyContent: "center", width: 44, height: 44,
        background: "transparent",
        border: "1px solid " + (isNight ? "#FF0000" : isDark ? "rgba(255,255,255,0.2)" : "rgba(0,0,0,0.15)"),
        borderRadius: 999, cursor: "pointer", color: S,
        opacity: phase === "intro" ? 1 : 0.95
      }, "aria-label": "Close" }, /*#__PURE__*/
    React.createElement("svg", { width: 20, height: 20, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /*#__PURE__*/React.createElement("path", { d: "M18 6L6 18M6 6l12 12" }))
    )
    ),
    ...
    React.createElement("div", { style: { fontSize: 24, fontWeight: 600, letterSpacing: "0.20em", textTransform: "uppercase", lineHeight: 1.4, color: W, marginBottom: 16, maxWidth: 320,
        textShadow: NAME_SHAD } }, "GUIDED COMPLETE"

    ), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: 15, color: S, marginBottom: 24, maxWidth: 300, lineHeight: 1.6 } }, "Take a few moments to breathe or rest."

    ), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: 12, color: D, marginBottom: 40, maxWidth: 280, lineHeight: 1.6 } }, "Click Exit to return to the main menu."
    ...
    React.createElement("div", { style: { letterSpacing: "0.3em", textTransform: "uppercase", color: S, marginBottom: 24 } }, "GUIDED SESSION"), /*#__PURE__*/
    React.createElement("div", { style: { fontWeight: 700, fontSize: 34, letterSpacing: "-0.03em", lineHeight: 1.02, color: W, marginBottom: 16, textShadow: NAME_SHAD } },
    trackLabel
    ), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: 20, color: S, marginBottom: 24, opacity: 0.9 } }, filteredCount, " exercises \u2022 ", trackDuration)
    ), /*#__PURE__*/
    React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", paddingBottom: 8 } }, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: 12, color: S, opacity: 0.85, maxWidth: 320, lineHeight: 1.4, marginBottom: 28, textAlign: "center" } }, "No equipment? You can modify \u2014 use a towel instead of a strap, a book instead of a block, or skip props and focus on range of motion."), /*#__PURE__*/
    React.createElement("button", { className: isNight ? "guided-cta-fill" : undefined, onClick: () => {primeAudio();beep(880, 0.3);setReadyLeft(GETREADY_SECONDS);setPhase("getready");}, style: {
    ...
    React.createElement("button", { onClick: onExit, style: {
        marginTop: 14, background: "none", border: nightMode ? "1px solid #FF0000" : "none", cursor: "pointer",
    ...
    React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", position: "relative", zIndex: 2, minHeight: 0, overflow: "hidden" } }, /*#__PURE__*/

    React.createElement("div", { style: { flex: "1 1 58%", minHeight: 0, overflowY: "auto", overflowX: "hidden", padding: "6px 16px 12px", WebkitOverflowScrolling: "touch", display: "flex", flexDirection: "column" } }, /*#__PURE__*/

    React.createElement("div", { style: { fontSize: 13, letterSpacing: "0.28em", textTransform: "uppercase", color: S, marginBottom: 8, flexShrink: 0, textAlign: "left" } },
    ...
    React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: phase === "getready" || phase === "launch" || phase === "exercise" ? "center" : "flex-start" } }, /*#__PURE__*/
    React.createElement("div", {
      ref: titleRef,
      style: {
    ...
    (phase === "getready" || phase === "launch" || phase === "exercise") && /*#__PURE__*/
    React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", marginTop: 6, marginBottom: 12, flexShrink: 0 } },
    phase === "getready" && /*#__PURE__*/
    React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("div", { style: { minWidth: 140, textAlign: "center", fontVariantNumeric: "tabular-nums", fontFamily: "'Barlow', sans-serif", fontSize: 64, fontWeight: 700, letterSpacing: "-0.02em", color: isNight ? "#FF0000" : isDark ? "rgba(255,255,255,0.5)" : W, lineHeight: 1 } },
    `0:${readyLeft.toString().padStart(2, "0")}`
    ), /*#__PURE__*/
    React.createElement("div", { style: { width: 240, height: 10, borderRadius: 10, background: isNight ? "#000000" : isDark ? "rgba(255,255,255,0.10)" : "rgba(0,0,0,0.08)", overflow: "hidden", marginTop: 8 } }, /*#__PURE__*/
    React.createElement("div", { style: { height: 10, borderRadius: 10, background: `linear-gradient(90deg,${A},${ct.accentDim || A + "99"})`, width: `${(GETREADY_SECONDS - readyLeft) / GETREADY_SECONDS * 100}%`, transition: "width 1s linear" } })
    )
    ),

    phase === "launch" && /*#__PURE__*/
    React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("div", { style: { minWidth: 140, textAlign: "center", fontVariantNumeric: "tabular-nums", fontFamily: "'Barlow', sans-serif", fontSize: 60, fontWeight: 700, letterSpacing: "-0.02em", color: W, lineHeight: 1 } },
    launchCount > 0 ? launchCount : ""
    ), /*#__PURE__*/
    React.createElement("div", { style: { width: 240, height: 10, borderRadius: 10, background: isNight ? "#000000" : isDark ? "rgba(255,255,255,0.10)" : "rgba(0,0,0,0.08)", overflow: "hidden", marginTop: 8 } }, /*#__PURE__*/
    React.createElement("div", { style: { height: 10, borderRadius: 10, background: `linear-gradient(90deg, ${A}, ${A})`, width: `${(3 - launchCount) / 3 * 100}%` } })
    )
    ),

    phase === "exercise" && cur && /*#__PURE__*/
    React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("div", { style: { minWidth: 140, textAlign: "center", fontVariantNumeric: "tabular-nums", fontFamily: "'Barlow', sans-serif", fontSize: 60, fontWeight: 700, letterSpacing: "-0.02em", color: W, lineHeight: 1 } }, gDisplay), /*#__PURE__*/
    React.createElement("div", { style: { width: 240, height: 10, borderRadius: 10, background: isNight ? "#000000" : isDark ? "rgba(255,255,255,0.10)" : "rgba(0,0,0,0.08)", overflow: "hidden", marginTop: 8 } }, /*#__PURE__*/
    React.createElement("div", { style: { height: 10, borderRadius: 10, background: `linear-gradient(90deg, ${A}, ${A})`, width: `${gPct * 100}%` } })
    )
    )
    ...
    (() => {
      ...
      return (/*#__PURE__*/
        React.createElement("div", { className: "glass-card", style: {
            borderRadius: 20,
            background: isExercisePhase && !isNight ?
            isDark ? "rgba(6,14,32,0.96)" : "rgba(252,252,255,0.98)" :
            isNight ? "#000000" : isDark ? "rgba(255,255,255,0.06)" : "rgba(255,255,255,0.45)",
            ...
            isNight ? "1px solid #FF0000" : isDark ? "1px solid rgba(255,255,255,0.22)" : "1px solid rgba(10,18,36,0.08)" :
            `1px solid ${isNight ? "#FF0000" : isDark ? "rgba(255,255,255,0.1)" : "rgba(0,0,0,0.08)"}`,
        ...
        React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 16px", borderBottom: "1px solid rgba(0,0,0,0)" } }, /*#__PURE__*/
        React.createElement("div", { style: { fontSize: 13, fontWeight: 700, letterSpacing: "0.06em", color: W } }, "Instructions"), /*#__PURE__*/
        React.createElement("button", {
          onClick: () => toggleCollapseFor(ex.id),
          style: { background: "transparent", border: nightMode ? "1px solid #FF0000" : "none", color: W, cursor: "pointer", fontWeight: 700, fontSize: 13 },
        ...
        !collapsedById[ex.id] && /*#__PURE__*/
        React.createElement(React.Fragment, null,
        ex.demoVideo && /*#__PURE__*/
        React.createElement("div", { style: { padding: "10px 16px 8px", borderBottom: ex.steps?.length ? isNight ? "1px solid #FF0000" : isDark ? "1px solid rgba(255,255,255,0.08)" : "1px solid rgba(0,0,0,0.06)" : "none", textAlign: "center" } }, /*#__PURE__*/
        React.createElement(VideoDemo, {
          src: ex.demoVideo,
        ...
        ex.start && /*#__PURE__*/
        React.createElement("div", { id: `instr-${ex.id}`, style: { padding: "10px 16px 8px", borderBottom: ex.steps?.length ? isNight ? "1px solid #FF0000" : isDark ? "1px solid rgba(255,255,255,0.08)" : "1px solid rgba(0,0,0,0.06)" : "none", textAlign: "left" } }, /*#__PURE__*/
        React.createElement("div", { style: { fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase", color: A, marginBottom: 4 } }, "START"), /*#__PURE__*/
        React.createElement("div", { style: { fontSize: 15, color: W, lineHeight: 1.4, fontWeight: 400, letterSpacing: "-0.01em" } }, ex.start)
        ),

        ex.steps?.map((step, idx) => /*#__PURE__*/
        React.createElement("div", {
          key: idx,
          style: {
            padding: idx === 0 ? "14px 16px 12px" : "12px 16px 14px",
            borderBottom: idx < ex.steps.length - 1 || ex.type === "reps" && ex.reps ?
            isNight ? "1px solid #FF0000" : isDark ? "1px solid rgba(255,255,255,0.08)" : "1px solid rgba(0,0,0,0.06)" :
            "none",
            textAlign: "left"
          } }, /*#__PURE__*/

        React.createElement("div", { style: { fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase", color: A, marginBottom: 8 } },
    ...
    phase !== "closing" && phase !== "milestone" && phase !== "intro" && /*#__PURE__*/
    React.createElement("div", { style: {
    ...
    React.createElement("button", { onClick: () => setPaused((p) => !p), style: {
        ...
        background: isNight ? "#000000" : isDark ? "rgba(255,255,255,0.08)" : "rgba(255,255,255,0.5)",
    ...
    React.createElement("button", { className: isNight ? "guided-cta-fill" : undefined, onClick: handleNext, style: {
        flex: 1, minWidth: 0, borderRadius: 999,
        background: A, border: nightMode ? "1px solid #FF0000" : "none",
        color: isNight ? "#000000" : "#ffffff",
        WebkitTextFillColor: isNight ? "#000000" : undefined,
        fontFamily: "'Barlow', sans-serif", fontSize: 11, fontWeight: 700,
        letterSpacing: "0.18em", textTransform: "uppercase", cursor: "pointer",
        boxShadow: `0 0 16px ${ct.accentGlow}`
      } }, fi === list.length - 1 ? "DONE" : "NEXT")
    ),



    phase === "getready" && /*#__PURE__*/
    React.createElement("button", { className: isNight ? "guided-cta-fill" : undefined, onClick: () => {clearInterval(readyRef.current);primeAudio();setLaunchCount(3);setPhase("launch");}, style: {
        flex: 1, width: "100%", minWidth: 0, background: A, border: nightMode ? "1px solid #FF0000" : "none",
        color: isNight ? "#000000" : "#ffffff",
        WebkitTextFillColor: isNight ? "#000000" : undefined,
        fontFamily: "'Barlow', sans-serif", fontSize: 12, fontWeight: 700,
    ...
    phase === "launch" && /*#__PURE__*/
    React.createElement("div", { style: { flex: 1, width: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: S, fontSize: 12, letterSpacing: "0.12em" } }, "STARTING...")
...
function TimerView({ theme, view, setView, hasActiveSession, css, nightMode = false, activePeriod = null }) {
  ...
  // Shift START upward by ~5% (reduce top flex share, increase bottom share evenly)
  const TIMER_BTN_SPACER_ABOVE_IDLE = { flex: 0.1425, minHeight: 0, width: "100%" };
  const TIMER_BTN_SPACER_BELOW_IDLE = { flex: 1.8575, minHeight: 0, width: "100%" };
  ...
  return (/*#__PURE__*/
    React.createElement("div", { className: "app", "data-theme": theme, "data-night": nightMode ? "true" : "false", style: { minHeight: "100dvh", display: "flex", flexDirection: "column", minWidth: "100%", boxSizing: "border-box" } }, /*#__PURE__*/
    React.createElement("style", null, css), /*#__PURE__*/
    React.createElement("style", null, timerFlatCss), /*#__PURE__*/
    ...
    React.createElement("div", { className: "app-body timer-view-body", style: {
    ...
    React.createElement("svg", { width: ringSize, height: ringSize, viewBox: "0 0 320 320", className: "timer-interval-ring", style: { transform: "rotate(-90deg)", display: "block", margin: "0 auto" } }, /*#__PURE__*/
    React.createElement("circle", { cx: "160", cy: "160", r: "140", fill: "none", stroke: "var(--border)", strokeWidth: "2.5" }),
    iPhase !== "idle" && iPhase !== "done" && /*#__PURE__*/
    React.createElement("circle", { cx: "160", cy: "160", r: "140", fill: "none",
    ...
    React.createElement("div", { style: { fontSize: "48px", fontWeight: 700, color: "var(--accent)", fontFamily: "'Barlow',sans-serif", lineHeight: 1 } }, "\u2713")
    ...
    React.createElement("div", { style: { flexShrink: 0, height: iPhase === "idle" ? TIMER_MID_IDLE_HEIGHT : undefined, minHeight: iPhase === "idle" ? TIMER_MID_IDLE_HEIGHT : 0, width: "100%", marginTop: 12, marginBottom: 12, boxSizing: "border-box" } },
    iPhase === "idle" && /*#__PURE__*/
    React.createElement("div", { className: "timer-glass-panel timer-interval-rows", style: { marginBottom: 0, width: "100%", boxSizing: "border-box", overflow: "hidden", borderRadius: 16 } },
    [
    ...
    React.createElement("button", { type: "button", "aria-label": `${label} decrease`, onClick: () => set((v) => Math.max(min, v - step)), className: "timer-glass-stepper timer-interval-stepper", style: { color: "var(--text-secondary)", fontSize: 18, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", border: "none" } }, "\u2212"), /*#__PURE__*/
    ...
    !isRound && /*#__PURE__*/React.createElement("span", { style: { fontSize: 12, color: "var(--text-dimmer)", fontFamily: "'Barlow',sans-serif" } }, "s")
    ), /*#__PURE__*/
    React.createElement("button", { type: "button", "aria-label": `${label} increase`, onClick: () => set((v) => Math.min(max, v + step)), className: "timer-glass-stepper timer-interval-stepper", style: { color: "var(--text-secondary)", fontSize: 18, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", border: "none" } }, "+")
    )
    )
    )
    )
    ...
    React.createElement("div", { style: iPhase === "idle" ? TIMER_BTN_SPACER_ABOVE_IDLE : TIMER_BTN_SPACER_ABOVE, "aria-hidden": true }), /*#__PURE__*/
    React.createElement("div", { style: iPhase === "idle" ? TIMER_BTN_ROW_IDLE : TIMER_BTN_ROW },
    iPhase === "idle" && /*#__PURE__*/React.createElement("button", { type: "button", onClick: () => {primeAudio();iStart();}, className: "timer-glass-btn-pri", style: BTN }, "Start"),
    (iPhase === "work" || iPhase === "rest") && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("button", { type: "button", onClick: () => setIRunning((r) => !r), className: "timer-glass-btn-pri", style: { ...BTN, padding: "12px 28px" } }, iRunning ? "Pause" : "Resume"), /*#__PURE__*/
    React.createElement("button", { type: "button", onClick: iReset, className: "timer-glass-btn-ghost", style: BTN_GHOST }, "Reset")
    ),
    iPhase === "done" && /*#__PURE__*/React.createElement("button", { type: "button", onClick: iReset, className: "timer-glass-btn-pri", style: BTN }, "Again")
    ), /*#__PURE__*/
    React.createElement("div", { style: iPhase === "idle" ? TIMER_BTN_SPACER_BELOW_IDLE : TIMER_BTN_SPACER_BELOW, "aria-hidden": true })
    ),


    mode === "breathe" && /*#__PURE__*/
    React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", width: "100%", flex: 1, minHeight: 0 } }, /*#__PURE__*/
    React.createElement("div", { className: "timer-glass-orb timer-breathe-ring-wrap timer-ring-slot", style: TIMER_RING_WRAP, "data-breathe-glow": bRunning ? (isInhalePhase ? "inhale" : "soft") : undefined }, /*#__PURE__*/
    ...
    React.createElement("circle", { cx: "160", cy: "160", r: "140", fill: "none", stroke: "var(--border)", strokeWidth: "1.5" })
    ),
    bRunning && !nightMode && /*#__PURE__*/
    ...
    React.createElement("svg", { className: "timer-breathe-glow", width: "306", height: "306", viewBox: "0 0 320 320", style: { position: "absolute", left: 0, top: 0, opacity: Math.max(orbOpacity ?? 0, 0.18), ['--breathe-fade']: `${breatheFadeDuration}s` } }, /*#__PURE__*/
    ...
    React.createElement("div", { style: { fontSize: "20px", fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--text-dimmer)", fontFamily: "'Barlow',sans-serif" } }, "Ready")
    ),
    ...
    React.createElement("div", { style: { position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" } }, /*#__PURE__*/
    React.createElement("div", { style: { ...intervalDigitStyle, fontSize: 72, minWidth: 72, color: isDark ? "var(--app-white)" : "var(--app-black)", opacity: countdownLabelOpacity, transition: "none" } }, formatSecondsOnly(bTime))
    )
    ),

    bDone && /*#__PURE__*/
    React.createElement("div", { style: { position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" } }, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: "42px", fontWeight: 700, color: "var(--accent)", fontFamily: "'Barlow',sans-serif", lineHeight: 1 } }, "\u2713")
    )
    ...
    bRunning && /*#__PURE__*/
    React.createElement("div", { className: "timer-glass-phase", style: { flexShrink: 0, width: "100%", textAlign: "center", padding: "9px 20px 10px", marginTop: -5, boxSizing: "border-box", minHeight: TIMER_PHASE_BAND, display: "flex", alignItems: "center", justifyContent: "center" } }, /*#__PURE__*/
    React.createElement("div", { style: {
        fontSize: 26,
        fontWeight: 700,
    ...
    bRunning && /*#__PURE__*/
    React.createElement("div", { style: { display: "flex", width: "100%", justifyContent: "center", marginTop: 6, marginBottom: 6 } }, /*#__PURE__*/
    ...
    React.createElement("div", { style: { flexShrink: 0, height: !bRunning && !bDone ? TIMER_MID_IDLE_HEIGHT : undefined, minHeight: !bRunning && !bDone ? TIMER_MID_IDLE_HEIGHT : 0, width: "100%", marginTop: 12, marginBottom: 12, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", boxSizing: "border-box" } },
    !bRunning && !bDone && /*#__PURE__*/
    React.createElement(React.Fragment, null, /*#__PURE__*/
    ...
    React.createElement("div", { style: { fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--text-dimmer)", fontFamily: "'Barlow',sans-serif", marginRight: 8 } }, "Cycles"), /*#__PURE__*/
    React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /*#__PURE__*/
    React.createElement("button", { type: "button", "aria-label": "Cycles decrease", onClick: () => setBreathCycles((v) => Math.max(1, v - 1)), className: "timer-glass-stepper timer-interval-stepper", style: { color: "var(--text-secondary)", fontSize: 18, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", border: "none" } }, "\u2212"), /*#__PURE__*/
    ...
    React.createElement("button", { type: "button", "aria-label": "Cycles increase", onClick: () => setBreathCycles((v) => Math.min(12, v + 1)), className: "timer-glass-stepper timer-interval-stepper", style: { color: "var(--text-secondary)", fontSize: 18, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", border: "none" } }, "+")
    )
    )
    )
    )
    ...
    React.createElement("div", { style: !bRunning && !bDone ? TIMER_BTN_SPACER_ABOVE_IDLE : TIMER_BTN_SPACER_ABOVE, "aria-hidden": true }), /*#__PURE__*/
    React.createElement("div", { style: !bRunning && !bDone ? TIMER_BTN_ROW_IDLE : TIMER_BTN_ROW },
    !bRunning && !bDone && /*#__PURE__*/React.createElement("button", { type: "button", onClick: () => {primeAudio();bStart();}, className: "timer-glass-btn-pri", style: BTN }, "Start"),
    bRunning && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/
    React.createElement("button", { type: "button", onClick: () => setBRunning((r) => !r), className: "timer-glass-btn-pri", style: { ...BTN, padding: "12px 28px" } }, "Pause"), /*#__PURE__*/
    React.createElement("button", { type: "button", onClick: bReset, className: "timer-glass-btn-ghost", style: BTN_GHOST }, "Reset")
    ),
    bDone && /*#__PURE__*/React.createElement("button", { type: "button", onClick: bReset, className: "timer-glass-btn-pri", style: BTN }, "Again")
    ), /*#__PURE__*/
    React.createElement("div", { style: !bRunning && !bDone ? TIMER_BTN_SPACER_BELOW_IDLE : TIMER_BTN_SPACER_BELOW, "aria-hidden": true })
    )

    )
    ), /*#__PURE__*/
    React.createElement(TabBar, { view: view, setView: setView, hasActiveSession: hasActiveSession, theme: theme, nightMode: nightMode })
    ));
...
function WorkoutApp({ theme, toggleTheme, nightMode = false, toggleNight = () => {}, onGuidedOpen }) {
  ...
  if (view === "timer") {
    return /*#__PURE__*/React.createElement(TimerView, { key: "timer", theme: theme, view: view, setView: setView, hasActiveSession: hasActiveSession, css: css, activePeriod: activePeriod, nightMode: nightMode });
  }
  if (view === "settings") return (/*#__PURE__*/
    ...
    React.createElement("div", { style: { fontSize: "12px", color: "var(--text-secondary)", lineHeight: 1.45, maxWidth: 280 } }, desc)
    ), /*#__PURE__*/
    ...
    React.createElement("div", { style: { borderTop: "1px solid var(--border)", paddingTop: 24, marginBottom: 32 } }, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: "13px", letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--text-dimmer)", marginBottom: 16 } }, "Session"), /*#__PURE__*/
    React.createElement("div", null, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: "14px", fontWeight: 500, color: "var(--text-white)", marginBottom: 8 } }, "Exercise duration (LIST)"), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: "12px", color: "var(--text-secondary)", lineHeight: 1.45, marginBottom: 12, maxWidth: 280 } }, "Timer length for each exercise in LIST view."), /*#__PURE__*/
    React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8 } },
    [30, 45, 60].map((sec) => /*#__PURE__*/
    React.createElement("button", { key: sec, onClick: () => setExerciseDuration(sec), style: { fontFamily: "'Barlow',sans-serif", fontSize: 12, letterSpacing: "0.06em", textTransform: "uppercase", padding: "8px 14px", borderRadius: 8, border: "1px solid", borderColor: exerciseDuration === sec ? "var(--accent)" : "var(--glass-border)", background: exerciseDuration === sec ? "var(--accent)" : "var(--glass-bg)", color: exerciseDuration === sec ? nightMode ? "#000" : "#fff" : "var(--text-secondary)", cursor: "pointer", fontWeight: 600 } },
  ...
  if (view === "mood") {
    ...
    return (/*#__PURE__*/
      ...
      React.createElement("div", { style: { fontSize: "14px", color: "var(--text-secondary)", marginBottom: 24, lineHeight: 1.45 } }, "Set the feeling of the app. Auto follows the time of day, or lock it to whatever matches how you feel right now."
      ...
      React.createElement("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 24, marginBottom: 56 } }, /*#__PURE__*/
      React.createElement("div", null, /*#__PURE__*/
      React.createElement("div", { style: { fontSize: "14px", fontWeight: 500, color: "var(--text-white)", marginBottom: 4 } }, "Night mode"), /*#__PURE__*/
      React.createElement("div", { style: { fontSize: "12px", color: "var(--text-secondary)", lineHeight: 1.45, maxWidth: 280 } }, "Pure black with vibrant red \u2014 like Apple Watch Ultra. For low-light use.")
      ), /*#__PURE__*/
  ...
  if (view === "home") {
    ...
    const homeHighlight = nightMode ? "#FF0000" : homeCt && homeCt.accent ? homeCt.accent : "var(--accent)";
    ...
    const todayInk = nightMode ? "#000000" : theme === "dark"
      ? "#252525"
      : (() => {
          const fromHex = /^#/.test(homeHighlight) ? inkForAccentHex(homeHighlight) : null;
          return fromHex != null ? fromHex : "#252525";
        })();
    const todayBtn = nightMode
      ? { background: "#000000", color: "#FF0000", border: "1px solid #FF0000" }
      : theme === "dark"
        ? { background: "#252525", color: "#f6f7f8", border: "none" }
        : { background: "#ffffff", color: "#252525", border: "none" };
    const groups = [
    ...
    return (/*#__PURE__*/
      ...
      React.createElement("div", { className: "app-label", style: { fontSize: 24, fontWeight: 600, textTransform: "uppercase", color: "var(--text-secondary)", marginBottom: 20 } }, "AXIS")
      ), /*#__PURE__*/
      React.createElement("div", { className: "home-tagline", id: "axis-home-greeting" }, "Listen to your body. Select your focus.")
      ), /*#__PURE__*/
      React.createElement("div", { className: "track-cards-outer" }, /*#__PURE__*/

      React.createElement("div", { className: "track-group start-here-group today-card", role: "region", "aria-label": "Today's suggestion", style: {
          marginBottom: 28, padding: "20px 20px 22px", borderRadius: 24,
          background: homeHighlight, border: `2px solid ${homeHighlight}`, borderTop: "1px solid rgba(255,255,255,0.12)",
          backdropFilter: nightMode ? "none" : "blur(24px) saturate(1.4)", WebkitBackdropFilter: nightMode ? "none" : "blur(24px) saturate(1.4)",
          boxShadow: nightMode ? "none" : `0 12px 32px ${homeHighlight}33, inset 0 1px 0 rgba(255,255,255,0.12), inset 0 1px 0 rgba(255,255,255,0.05)`
        } }, /*#__PURE__*/
      React.createElement("div", { style: { letterSpacing: "0.22em", textTransform: "uppercase", color: todayInk, marginBottom: 8, fontWeight: 600 } }, "Today"), /*#__PURE__*/
      React.createElement("div", { style: { fontWeight: 600, color: todayInk, marginBottom: 6 } }, periodLabels[nowPeriod]), /*#__PURE__*/
      React.createElement("div", { style: { color: todayInk, marginBottom: 6, lineHeight: 1.4 } }, todaySug.suggestion), /*#__PURE__*/
      React.createElement("div", { style: { color: todayInk, letterSpacing: "0.06em", marginBottom: 18 } }, getTrackDisplayDuration(todayTrack.id)), /*#__PURE__*/
      React.createElement("button", {
        className: "begin-btn begin-btn--today-primary",
        onClick: () => beginTrack(todayTrack.id),
        style: {
          width: "100%",
          padding: "14px 24px",
          fontSize: 15,
      ...
      g.ids.map((id) => {const t = TRACKS[id];const cardDur = getTrackDisplayDuration(t.id);return (/*#__PURE__*/
          React.createElement("div", { className: "track-card session-card", key: t.id, onClick: () => beginTrack(t.id), role: "button", tabIndex: 0, onKeyDown: (e) => {if (e.key === "Enter" || e.key === " ") {e.preventDefault();beginTrack(t.id);}}, "aria-label": `${t.label}, ${cardDur}. Begin session` }, /*#__PURE__*/
          React.createElement("div", { className: "track-card-left" }, /*#__PURE__*/
          React.createElement("div", { className: "metadata-restore", style: { color: "var(--mood-accent)", fontWeight: 700, fontSize: 11, marginBottom: 4, textTransform: "uppercase" } }, "SPINE • CORE • POSTERIOR"), /*#__PURE__*/
  ...
  // SESSION — empty state: dark #0B121C + light mark, or light gradient + dark mark (matches app theme)
  if (view === "session" && !hasActiveSession) {
    const sessionEmptyDark = theme === "dark";
    const sessionBg = sessionEmptyDark ? "#0B121C" : MAIN_APP_BG.light;
    const sessionHeadline = nightMode && sessionEmptyDark ? "#FF0000" : sessionEmptyDark ? "#ffffff" : "rgba(15,30,46,0.92)";
    const sessionTagline = "#7d7d7d";
    const sessionLogo = AXIS_BRANDING_SESSION;
    return (/*#__PURE__*/
      React.createElement("div", { className: "app", "data-theme": theme, "data-night": nightMode ? "true" : "false" }, /*#__PURE__*/
      React.createElement("style", null, css), /*#__PURE__*/
      React.createElement("style", null, `@import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;700&display=swap');`), /*#__PURE__*/
      React.createElement("div", {
        className: "app-body",
        style: {
          display: "flex",
      ...
      React.createElement("div", { style: {
          ...
          alignItems: "center",
          flexShrink: 0,
          paddingTop: "clamp(72px, calc(env(safe-area-inset-top, 0px) + min(30vh, 240px)), 280px)"
        } }, /*#__PURE__*/
      React.createElement("div", { style: { fontSize: 14, fontWeight: 300, color: sessionHeadline, marginBottom: 28, textAlign: "center", maxWidth: "min(100%, 360px)" } }, "Ready for movement."
      ...
      React.createElement("div", { style: {
          ...
          paddingBottom: "clamp(8px, 2vh, 28px)"
        } }, /*#__PURE__*/
      React.createElement("div", { style: {
          display: "flex",
          flexDirection: "column",
      ...
      React.createElement("img", {
        src: sessionLogo,
        alt: "AXIS",
        style: { width: 72, height: "auto", objectFit: "contain", opacity: 1, marginBottom: 36 } }
      ), /*#__PURE__*/
      React.createElement("div", {
        style: {
          fontFamily: "'Barlow', sans-serif",
  ...
  return (/*#__PURE__*/
    ...
    null, /*#__PURE__*/
    React.createElement("div", { className: "hdr-dur" }, sessionDurationLabel)
    ), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: 11, color: "var(--text-dimmer)", marginTop: 8 } },
    tabSubtitle
    )
    )
    ), /*#__PURE__*/
    ...
    React.createElement("div", { className: "content content--session", ref: sessionContentRef, onScroll: (e) => {
        if (tab === "list") {
    ...
    tab === "guided" && /*#__PURE__*/
    React.createElement("div", { style: { padding: "14px 0 6px" } }, /*#__PURE__*/
    React.createElement("button", {
      className: "fv-cta",
      disabled: filteredAll.length === 0,
      onClick: () => {if (filteredAll.length > 0) {primeAudio();setGuidedActive(true);}} }, /*#__PURE__*/
    ...
    (() => {
      ...
      return (/*#__PURE__*/
        ...
        flat.length, " moves \xB7 ", perMoveSeconds, " seconds each"
        )
        ));
    ...
    React.createElement("div", { style: { marginTop: 24, padding: "4px 0 8px" } }, /*#__PURE__*/
    React.createElement("button", {
      type: "button",
      onClick: () => {if (filteredAll.length > 0) {primeAudio();setTab("guided");setGuidedActive(true);}},
      disabled: filteredAll.length === 0,
      style: {
        width: "100%", padding: "14px 18px", borderRadius: 999, border: nightMode ? "1px solid #FF0000" : "none",
        background: "var(--accent)", color: nightMode ? "#FF0000" : "#ffffff",
        fontFamily: "'Barlow',sans-serif", fontSize: 12, fontWeight: 700,
        letterSpacing: "0.18em", textTransform: "uppercase", cursor: "pointer",
