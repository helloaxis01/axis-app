...
async function save_consent(payload) {
  ...
  if (String(key).indexOf("PASTE YOUR") !== -1) return;
  ...
  try {
    ...
    if (!res.ok) {
      try {
        console.warn("[AXIS] save_consent failed", res.status, await res.text());
      } catch (e) {
        console.warn("[AXIS] save_consent failed", res.status);
      }
    }
  } catch (err) {
...
function AxisIcon({ size = 72, color = "#F0EEEB" }) {
  ...
  return /* @__PURE__ */ React.createElement("svg", { width: S, height: S, viewBox: `0 0 ${S} ${S}` }, positions.flatMap(
    ([x, y]) => [-45, 45].map((angle) => /* @__PURE__ */ React.createElement(
      "rect",
      {
        key: `${x}-${y}-${angle}`,
        x: x - xSize / 2,
...
const OB_GREY = {
  dark: {
    ...
    accent: "#9ca3af",
    accentDim: "rgba(156,163,175,0.2)",
    accentGlow: "rgba(156,163,175,0.15)",
    accentBtnText: "#0f0f12",
    textPrimary: "#ffffff",
    tabBg: "rgba(8,12,18,0.82)"
  },
  light: {
...
const CIRCADIAN_THEMES = {
  ...
  dawn: {
    dark: {
      ...
      accent: "#FF9F43",
      accentDim: "rgba(255,159,67,0.28)",
      accentGlow: "rgba(255,159,67,0.58)",
    ...
    light: {
      ...
      accent: "#C85A00",
      accentDim: "rgba(200,90,0,0.18)",
      accentGlow: "rgba(200,90,0,0.38)",
      accentBtnText: "var(--axis-white)",
  ...
  midday: {
    dark: {
      ...
      accent: "#00E8C0",
      accentDim: "rgba(0,232,192,0.20)",
      accentGlow: "rgba(0,232,192,0.52)",
    ...
    light: {
      ...
      accent: "#007A6A",
      accentDim: "rgba(0,122,106,0.16)",
      accentGlow: "rgba(0,122,106,0.34)",
      accentBtnText: "var(--axis-white)",
  ...
  prime: {
    dark: {
      ...
      accent: "#4DA8FF",
      accentDim: "rgba(77,168,255,0.22)",
      accentGlow: "rgba(77,168,255,0.55)",
    ...
    light: {
      ...
      accent: "#1060C0",
      accentDim: "rgba(16,96,192,0.17)",
      accentGlow: "rgba(16,96,192,0.38)",
      accentBtnText: "var(--axis-white)",
  ...
  rest: {
    dark: {
      ...
      accent: "#A060FF",
      accentDim: "rgba(160,96,255,0.22)",
      accentGlow: "rgba(160,96,255,0.52)",
    ...
    light: {
      ...
      accent: "#6030B0",
      accentDim: "rgba(96,48,176,0.18)",
      accentGlow: "rgba(96,48,176,0.38)",
      accentBtnText: "var(--axis-white)",
...
function Onboarding({ theme, onComplete }) {
  ...
  const [obAutoTime, setObAutoTime] = useState(false);
  ...
  const periodForTheme = obAutoTime ? getCircadianPeriod() : obPeriod != null ? obPeriod : getCircadianPeriod();
  const ct = CIRCADIAN_THEMES[periodForTheme][obTheme === "dark" ? "dark" : "light"];
  const useGrey = cur < 6 || cur === 6 && !hasChosenMood;
  const t = useGrey ? OB_GREY[obTheme === "dark" ? "dark" : "light"] : { ...ct, bg: MAIN_APP_BG[obTheme === "dark" ? "dark" : "light"] };
  ...
  useLayoutEffect(() => {
    const reset = () => {
      ...
      const screen = (_a = obShellRef.current) == null ? void 0 : _a.querySelector(".ob-screen");
  ...
  useEffect(() => {
    ...
    const record = { name, date: (/* @__PURE__ */ new Date()).toISOString().split("T")[0], timestamp: (/* @__PURE__ */ new Date()).toISOString(), accepted: true };
    try {
      localStorage.setItem("axis_disclaimer", JSON.stringify(record));
    } catch (e) {
    }
  ...
  const doSafetyNext = () => {
    ...
    const record = { name: disclaimerName.trim(), date: (/* @__PURE__ */ new Date()).toISOString().split("T")[0], timestamp: (/* @__PURE__ */ new Date()).toISOString(), accepted: true };
    try {
      localStorage.setItem("axis_disclaimer", JSON.stringify(record));
    } catch (e) {
    }
  ...
  const doLaunch = () => {
    ...
    const launchPeriod = obAutoTime ? null : (_a = obPeriod != null ? obPeriod : selectedMoodPeriod) != null ? _a : getCircadianPeriod();
    try {
  ...
  function NavBtn({ onClick, disabled, accent: accent2, label, filled }) {
  ...
  function SlideShell({ children, className = "" }) {
    return /* @__PURE__ */ React.createElement("div", { className: `ob-screen ob-content-only ${className}`.trim() }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body", style: { position: "relative", zIndex: 10 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, children)));
  }
    ...
    return /* @__PURE__ */ React.createElement(
      "div",
      {
        ...
        style: {
          ...
          color: accent2 || "rgba(255,255,255,0.35)",
          marginBottom: 10,
  ...
  function Headline({ children }) {
    return /* @__PURE__ */ React.createElement("div", { className: "ob-heading" }, children);
  }
  function Body({ children }) {
    return /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 18 } }, children);
  }
  function MoodSelectSlide({ accent: accent2, selectedMood: selectedMood2, onSelect, obAutoTime: obAutoTime2, setObAutoTime: setObAutoTime2, obTheme: obTheme2, setObTheme: setObTheme2 }) {
    const nowPeriod = getCircadianPeriod();
    const isLight = obTheme2 === "light";
    const moodCopyPrimary = obTheme2 === "light" ? "#252525" : "#fff";
    const moodCopySecondary = obTheme2 === "light" ? "#252525" : "rgba(255,255,255,0.45)";
    const moodCopyMeta = obTheme2 === "light" ? "#252525" : "rgba(255,255,255,0.3)";
    const moodIcon = (id, color) => {
      if (id === "rise") {
        return /* @__PURE__ */ React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: color, strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M4 16 A 8 8 0 0 1 20 16" }), /* @__PURE__ */ React.createElement("line", { x1: "0", y1: "16", x2: "24", y2: "16" }));
      }
      if (id === "midday") {
        return /* @__PURE__ */ React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: color, strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "12", r: "4" }), /* @__PURE__ */ React.createElement("line", { x1: "12", y1: "2", x2: "12", y2: "5" }), /* @__PURE__ */ React.createElement("line", { x1: "12", y1: "19", x2: "12", y2: "22" }), /* @__PURE__ */ React.createElement("line", { x1: "4.22", y1: "4.22", x2: "6.34", y2: "6.34" }), /* @__PURE__ */ React.createElement("line", { x1: "17.66", y1: "17.66", x2: "19.78", y2: "19.78" }), /* @__PURE__ */ React.createElement("line", { x1: "2", y1: "12", x2: "5", y2: "12" }), /* @__PURE__ */ React.createElement("line", { x1: "19", y1: "12", x2: "22", y2: "12" }), /* @__PURE__ */ React.createElement("line", { x1: "4.22", y1: "19.78", x2: "6.34", y2: "17.66" }), /* @__PURE__ */ React.createElement("line", { x1: "17.66", y1: "6.34", x2: "19.78", y2: "4.22" }));
      }
      if (id === "prime") {
        return /* @__PURE__ */ React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: color, strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" }));
      }
      return /* @__PURE__ */ React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: color, strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M12 3l1.5 5.5 6 .5-4.5 4 1.5 5.5L12 16l-4.5 2 1.5-5.5-4.5-4 6-.5L12 3z" }));
    };
    return /* @__PURE__ */ React.createElement(SlideShell, { className: "ob-screen-appearance" }, /* @__PURE__ */ React.createElement(Tag, { accent: accent2 }, "APPEARANCE"), /* @__PURE__ */ React.createElement(Headline, null, "Pick your Mood."), /* @__PURE__ */ React.createElement(Body, null, "AXIS shifts its color with the time of day - or lock it to match how you feel right now. Pick one to preview it through the rest of onboarding."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "12px 14px", borderRadius: 12, background: isLight ? "rgba(37,37,37,0.04)" : "rgba(255,255,255,0.04)", border: isLight ? "1px solid rgba(37,37,37,0.16)" : "1px solid rgba(255,255,255,0.08)", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 600, color: moodCopyPrimary } }, "Auto"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 400, color: moodCopySecondary } }, obAutoTime2 ? "Follows time of day" : "Lock to a mood")), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        onClick: () => setObAutoTime2((v) => !v),
        style: {
          flexShrink: 0,
          width: 44,
          height: 26,
          border: "1px solid",
          borderColor: obAutoTime2 ? accent2 : isLight ? "rgba(37,37,37,0.2)" : "rgba(255,255,255,0.14)",
          borderRadius: 13,
          background: obAutoTime2 ? accent2 : isLight ? "rgba(37,37,37,0.08)" : "rgba(255,255,255,0.06)",
          cursor: "pointer",
          position: "relative",
          transition: "all 0.2s",
          boxSizing: "border-box"
        },
        "aria-label": obAutoTime2 ? "Turn off automatic mood" : "Turn on automatic mood"
      },
      /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", top: 3, left: obAutoTime2 ? 22 : 3, width: 18, height: 18, borderRadius: "50%", background: "rgba(255,255,255,0.95)", transition: "left 0.2s", boxShadow: "0 1px 4px rgba(0,0,0,0.3)" } })
    )), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, fontWeight: 600, letterSpacing: "0.18em", color: "var(--ob-text-sec)", marginBottom: 8 } }, "BASE THEME"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, padding: 3, border: isLight ? "1px solid rgba(37,37,37,0.16)" : "1px solid rgba(255,255,255,0.12)", borderRadius: 12 } }, [{ val: "dark", label: "Dark" }, { val: "light", label: "Light" }].map(({ val, label }) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: val,
        type: "button",
        onClick: () => setObTheme2(val),
        style: {
          flex: 1,
          padding: "10px 8px",
          borderRadius: 10,
          border: "1px solid transparent",
          background: obTheme2 === val ? "color-mix(in srgb, var(--ob-accent) 16%, transparent)" : "transparent",
          color: obTheme2 === val ? "var(--ob-accent)" : "var(--text-dim)",
          cursor: "pointer",
          fontSize: 11,
          fontWeight: 600,
      ...
      const active = obAutoTime2 ? mapMoodIdToPeriod(m.id) === nowPeriod : selectedMood2 && selectedMood2.id === m.id;
      return /* @__PURE__ */ React.createElement(
        "div",
        {
          key: m.id,
          onClick: () => {
            if (obAutoTime2) return;
            onSelect(m);
          },
          style: {
            display: "flex",
            ...
            padding: "14px 16px",
            borderRadius: 14,
            border: active ? `1.5px solid ${m.accent}` : isLight ? "1px solid rgba(37,37,37,0.16)" : "1px solid rgba(255,255,255,0.08)",
            background: active ? `rgba(${hexToRgb(m.accent)}, 0.1)` : isLight ? "rgba(37,37,37,0.04)" : "rgba(255,255,255,0.04)",
            cursor: obAutoTime2 ? "default" : "pointer",
            transition: "all 0.25s ease",
            marginBottom: 10,
            pointerEvents: obAutoTime2 ? "none" : "auto"
          }
        },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 15, fontWeight: 600, color: moodCopyPrimary } }, m.label), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: moodCopyMeta } }, m.time)), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 400, color: moodCopySecondary, marginTop: 2 } }, m.desc)),
  ...
  function ModeCard({ accent: accent2, label, desc }) {
    const isLight = obTheme === "light";
    return /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          padding: "16px",
          borderRadius: 16,
          border: isLight ? "1px solid rgba(37,37,37,0.14)" : `1px solid rgba(${hexToRgb(accent2)}, 0.28)`,
          background: isLight ? "rgba(255,255,255,0.46)" : `linear-gradient(145deg, rgba(${hexToRgb(accent2)}, 0.08), rgba(255,255,255,0.035))`,
          marginBottom: 10,
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, marginBottom: 6 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-mode-card-label", style: { marginBottom: 0 } }, label)),
      /* @__PURE__ */ React.createElement("div", { className: "ob-mode-card-desc" }, desc)
    );
  }
  return /* @__PURE__ */ React.createElement("div", { className: "ob-wrap", "data-theme": obTheme, style: { background: cur === 10 ? "#000000" : t.bg, color: obTheme === "dark" ? "var(--axis-white)" : "var(--axis-black)", transition: "background 0.45s ease, color 0.45s ease" } }, /* @__PURE__ */ React.createElement("style", null, obCss, `:root,body,[data-ob]{${vars}}.ob-wrap{${vars}}`), /* @__PURE__ */ React.createElement("div", { className: "ob-orbs-layer", style: {
    ...
    "div",
    {
      ...
      onClick: (e) => {
        if (cur === 0 || cur === 5 || cur === 6 || cur === 10) return;
        if (!e.target.closest("button") && !e.target.closest("input") && !e.target.closest(".ob-disclaimer-check")) go(cur + 1);
      }
    },
    /* @__PURE__ */ React.createElement(
      "div",
    ...
    /* @__PURE__ */ React.createElement(
      ...
      cur === 0 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-intro-hero", style: { position: "relative" } }, /* @__PURE__ */ React.createElement("div", { className: "ob-intro-hero__inner" }, /* @__PURE__ */ React.createElement("h1", { className: "ob-intro-hero__wordmark" }, "AXIS"), /* @__PURE__ */ React.createElement("p", { className: "ob-intro-hero__sub" }, "X MOVE X MEND X MAINTAIN X"), /* @__PURE__ */ React.createElement("span", { className: "ob-intro-hero__accent-bar", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("p", { className: "ob-intro-hero__body" }, "Personalized mobility for exactly", /* @__PURE__ */ React.createElement("br", null), "where you are right now."))),
      cur === 1 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-content-only ob-screen-perspective" }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body" }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow" }, "The Perspective"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading" }, "Modern life beats up your body."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 16 } }, 'Screens, desks, and stress are just some of the things that contribute to back pain and "tech neck." AXIS is your reset button.'), /* @__PURE__ */ React.createElement("div", { className: "ob-sci-blocks ob-sci-blocks--perspective-stats" }, /* @__PURE__ */ React.createElement("div", { className: "ob-sci" }, /* @__PURE__ */ React.createElement("div", { className: "ob-sci-text" }, "80% of us get back pain.")), /* @__PURE__ */ React.createElement("div", { className: "ob-sci" }, /* @__PURE__ */ React.createElement("div", { className: "ob-sci-text" }, "70% of desk workers fight neck tension.")), /* @__PURE__ */ React.createElement("div", { className: "ob-sci" }, /* @__PURE__ */ React.createElement("div", { className: "ob-sci-text" }, "100% feel better moving smarter.")))))),
      cur === 2 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-content-only ob-screen-foundation" }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body" }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow" }, "The Foundation"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading" }, "Movement equals medicine."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 0 } }, "AXIS isn't a workout. It's a nervous system reset with proven moves that dial down pain and wake up your core."), /* @__PURE__ */ React.createElement("div", { className: "ob-sci-blocks ob-sci-blocks--foundation-callout" }, /* @__PURE__ */ React.createElement("div", { className: "ob-sci" }, /* @__PURE__ */ React.createElement("div", { className: "ob-sci-text" }, "Show up and move. Your body does the rest.")))))),
      cur === 3 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-content-only" }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body" }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow" }, "The Science"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading" }, "Motion is needed for your body to repair."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 0 } }, "Consistent therapeutic movement can support pain reduction, better function, and more confidence in your body."), /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow" }, "The Method"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading" }, "One session. Total reset."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 0 } }, "Quick resets or deeper sessions. AXIS fits your day. We handle the cues so you can stay in the flow.")))),
      cur === 4 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-content-only" }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body" }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow" }, "The Ethics"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading" }, "Your data is your data."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 28 } }, "We only ask for what the app needs: your safety acknowledgment and a few preferences to shape your first session. We don't ask for your age. We don't ask for your weight. No ads. No behavioral tracking. If you create an account, your saved sessions and bookmarks can sync across your devices.")))),
      cur === 5 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-cta-screen ob-safety-navy ob-content-only ob-screen-safety" }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body" }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow" }, "The Safety"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading" }, "A note on your safety."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 16 } }, "AXIS provides movement guidance for general wellness. We are a supportive partner, not a substitute for medical advice. Listen to your body and stop if something hurts."), /* @__PURE__ */ React.createElement("div", { className: "ob-sci-blocks", style: { marginBottom: 28 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-sci" }, /* @__PURE__ */ React.createElement("div", { className: "ob-sci-text" }, "By continuing, you are taking responsibility for your journey. Let's move."))), /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow" }, "Medical Disclaimer"), /* @__PURE__ */ React.createElement("div", { className: "ob-content-card ob-content-legalese", style: { marginBottom: 24 } }, "AXIS provides movement guidance for general wellness purposes only. It is not a substitute for professional medical advice, diagnosis, or treatment. The exercises and routines in this app are not designed to treat any medical condition.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("br", null), "If you have any injury, chronic pain, cardiovascular condition, or other health concern, consult a qualified healthcare professional before beginning any exercise program. Stop immediately and seek medical attention if you experience pain, dizziness, shortness of breath, or discomfort during any movement.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("br", null), "By continuing, you acknowledge that you are participating voluntarily and assume full responsibility for your use of this app."), /* @__PURE__ */ React.createElement("div", { style: { width: "100%", marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-ts-label" }, "Your Name"), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "text",
          ...
          onChange: (e) => {
            setDisclaimerName(e.target.value);
          ...
          style: {
            ...
            border: disclaimerWarning && !disclaimerName ? "1.5px solid rgba(255,100,100,0.7)" : "1px solid var(--ob-box-border)",
            color: "var(--ob-text-head)",
            outline: "none",
            boxSizing: "border-box",
      ...
      )), /* @__PURE__ */ React.createElement("div", { style: { width: "100%", marginBottom: 24 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-ts-label" }, "Date"), /* @__PURE__ */ React.createElement("div", { style: {
        padding: "12px 16px",
        borderRadius: 12,
        fontSize: 15,
        fontFamily: "var(--font-ui),system-ui,sans-serif",
        fontWeight: 400,
        background: "var(--ob-box-bg)",
        border: "1px solid var(--ob-box-border)",
        ...
        } }, disclaimerChecked && /* @__PURE__ */ React.createElement("svg", { width: "12", height: "10", viewBox: "0 0 12 10", fill: "none" }, /* @__PURE__ */ React.createElement("path", { d: "M1 5L4.5 8.5L11 1.5", stroke: "#0a0e1a", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }))),
        /* @__PURE__ */ React.createElement("div", { className: "ob-body ob-disclaimer-check__label", style: { lineHeight: 1.45, flex: "1 1 0", minWidth: 0, maxWidth: "100%", boxSizing: "border-box" } }, "I have read and understand the disclaimer above. I confirm I am using this app at my own risk and will consult a healthcare professional if I have any concerns.")
      ), disclaimerWarning && /* @__PURE__ */ React.createElement("div", { style: {
        width: "100%",
        marginBottom: 16,
        padding: "10px 14px",
        borderRadius: 10,
        ...
        lineHeight: 1.5
      } }, !disclaimerName && !disclaimerChecked ? "Please enter your name and check the box to continue." : !disclaimerName ? "Please enter your name to continue." : "Please check the box to confirm you've read the disclaimer.")))),
      cur === 6 && /* @__PURE__ */ React.createElement(
        MoodSelectSlide,
        {
          accent,
          selectedMood,
      ...
      cur === 10 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-content-only ob-ultra-content", style: { background: "#000000", color: "#FF3B30" } }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body", style: { position: "relative", zIndex: 10 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow" }, "Ultra Mode"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading" }, "Protect your night vision."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 22 } }, "Ultra Mode uses a pure black canvas with vibrant red accents so your eyes stay adapted in low light."), /* @__PURE__ */ React.createElement("div", { className: "ob-ultra-note" }, "Best for late-night sessions when you want to minimize glare, reduce eye fatigue, and keep your surroundings visible."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginTop: 12 } }, "Enable this option from System, then Mood."), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, display: "flex", alignItems: "center", justifyContent: "flex-start" } }, /* @__PURE__ */ React.createElement("svg", { className: "ob-ultra-eye-mark", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M1.5 12s3.8-6 10.5-6 10.5 6 10.5 6-3.8 6-10.5 6S1.5 12 1.5 12z" }), /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "12", r: "2.5" })))))),
      cur === 7 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-content-only ob-screen-session-modes" }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body", style: { position: "relative", zIndex: 10 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, /* @__PURE__ */ React.createElement(Tag, { accent }, "TRACK OPTIONS"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading" }, "Choose how to move."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 22 } }, "Every track gives you two ways in. Start the timed flow, or scroll the exercise list and move at your own pace."), /* @__PURE__ */ React.createElement("div", { className: "ob-mode-cards" }, /* @__PURE__ */ React.createElement(
        ModeCard,
        {
          accent,
      ...
      ), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", fontFamily: "var(--font-meta)", fontSize: 10, letterSpacing: "0.18em", color: "var(--ob-text-sec)", margin: "2px 0 10px" } }, "OR"), /* @__PURE__ */ React.createElement(
        ModeCard,
        {
          accent,
      ...
      )), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginTop: 18 } }, "You can switch approach every time you open a track.")))),
      cur === 8 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-content-only ob-screen-tab-guide" }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body", style: { position: "relative", zIndex: 10 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow", style: { color: obTheme === "light" ? "#252525" : void 0 } }, "The Lower Tab Menu"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading", style: { color: obTheme === "light" ? "#252525" : void 0 } }, "What each tab does."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 22, color: obTheme === "light" ? "#252525" : void 0 } }, "Same five tabs as the main app (left to right):"), /* @__PURE__ */ React.createElement("div", { className: "ob-tab-guide-list" }, [
        ["HOME", "Your main library and daily suggestions that change based on the time of day and what you're doing.", /* @__PURE__ */ React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M3 22V9L12 2l9 7v13h-6v-10H9v10H3z" }))],
        ["BOOKMARKS", "Everything you've saved, from full routines down to the specific exercises you like most.", /* @__PURE__ */ React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M6.5 3.5h11c.83 0 1.5.67 1.5 1.5v15.28l-7-5.42-7 5.42V5c0-.83.67-1.5 1.5-1.5Z" }))],
        ["TIMER", "Simple timers for breathing or your own workouts. Use them to unwind, focus, or cool down.", /* @__PURE__ */ React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "12", r: "10" }), /* @__PURE__ */ React.createElement("path", { d: "M12 7.5 L12 12 L17 12" }))],
        ["METRICS", "A quick look at how you're doing this week and notes on your recent sessions.", /* @__PURE__ */ React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "12", r: "10" }), /* @__PURE__ */ React.createElement("polyline", { points: "8 12.5 11 15.5 16.5 9" }))],
        ["SYSTEM", "The spot to tweak your theme, mood, and how the app feels, plus all your other settings.", /* @__PURE__ */ React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("rect", { x: "3.5", y: "3.5", width: "6.5", height: "6.5", rx: "0.75" }), /* @__PURE__ */ React.createElement("rect", { x: "14", y: "3.5", width: "6.5", height: "6.5", rx: "0.75" }), /* @__PURE__ */ React.createElement("rect", { x: "3.5", y: "14", width: "6.5", height: "6.5", rx: "0.75" }), /* @__PURE__ */ React.createElement("rect", { x: "14", y: "14", width: "6.5", height: "6.5", rx: "0.75" }))]
      ].map(([label, body, icon]) => /* @__PURE__ */ React.createElement(
        "div",
        {
          key: label,
        ...
        /* @__PURE__ */ React.createElement("span", { className: "ob-tab-guide-divider", "aria-hidden": "true", style: { background: obTheme === "light" ? "rgba(37,37,37,0.22)" : "rgba(255,255,255,0.16)" } }),
        /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0, flex: 1 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-tab-guide-title", style: { color: obTheme === "light" ? "#252525" : void 0 } }, label), /* @__PURE__ */ React.createElement("div", { className: "ob-tab-guide-desc", style: { color: obTheme === "light" ? "#252525" : void 0 } }, body))
      )))))),
      cur === 9 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-content-only ob-screen-upper-bar" }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body", style: { position: "relative", zIndex: 10 } }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad" }, /* @__PURE__ */ React.createElement("div", { className: "ob-eyebrow", style: { color: obTheme === "light" ? "#252525" : void 0 } }, "The Upper Bar"), /* @__PURE__ */ React.createElement("div", { className: "ob-heading", style: { color: obTheme === "light" ? "#252525" : void 0 } }, "Your daily snapshot."), /* @__PURE__ */ React.createElement("div", { className: "ob-body", style: { marginBottom: 18, color: obTheme === "light" ? "#252525" : void 0 } }, "The bar stays at the top everywhere in the app. The pill on the left is your progress toward today's movement goal. The seven squares on the right are the last seven days, lit when you logged a workout that day."), /* @__PURE__ */ React.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React.createElement("div", { className: "ob-upper-bar-demo__row" }, /* @__PURE__ */ React.createElement("div", { className: "ob-upper-bar-demo__progress-track" }, /* @__PURE__ */ React.createElement("div", { className: "ob-upper-bar-demo__progress-fill" })), /* @__PURE__ */ React.createElement("div", { className: "ob-upper-bar-demo__brand" }, "AXIS"), /* @__PURE__ */ React.createElement("div", { className: "ob-upper-bar-demo__streak" }, [true, true, true, false, true, false, false].map((on, i) => /* @__PURE__ */ React.createElement("span", { key: i, className: "ob-upper-bar-demo__cell" + (on ? " ob-upper-bar-demo__cell--on" : "") }))))
      )))),
      cur === 11 && /* @__PURE__ */ React.createElement("div", { className: "ob-screen ob-cta-screen ob-launch-screen ob-content-only", style: { color: "var(--ob-text-head)", transition: "color 0.6s ease" } }, /* @__PURE__ */ React.createElement("div", { className: "ob-screen-body" }, /* @__PURE__ */ React.createElement("div", { className: "ob-pad", style: { display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", maxWidth: 420, marginLeft: "auto", marginRight: "auto" } }, /* @__PURE__ */ React.createElement("h1", { className: "ob-launch-wordmark" }, "AXIS"), /* @__PURE__ */ React.createElement("p", { className: "ob-launch-headline" }, "You're ready."), /* @__PURE__ */ React.createElement("p", { className: "ob-launch-support" }, "Pick a track and start feeling better."), /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "ob-ext-nav" }, ["Intro", "Perspective", "Foundation", "Science \xB7 Method", "Ethics", "Safety", "Appearance", "Track Options", "The Lower Tab Menu", "The Upper Bar", "Ultra Mode", "Launch"].map((l, i) => /* @__PURE__ */ React.createElement("button", { key: l, className: "ob-en-btn", onClick: () => go(i) }, l)), /* @__PURE__ */ React.createElement("button", { className: "ob-en-btn", style: { borderColor: "#FFBF65", color: "#FFBF65" }, onClick: () => go(11) }, "\u2192 Launch Screen")), /* @__PURE__ */ React.createElement("div", { className: "ob-label" }, "Tap screen or use controls \xB7 Begin buttons launch the app"), /* @__PURE__ */ React.createElement(
    "div",
    {
      ...
      style: {
        ...
        minHeight: 100,
        height: "auto",
        paddingBottom: "var(--axis-safe-bottom)",
        paddingTop: 10,
        paddingLeft: 24,
        paddingRight: 24,
        zIndex: 1e3,
    ...
    /* @__PURE__ */ React.createElement("div", { className: "ob-footer-row" }, /* @__PURE__ */ React.createElement("div", { className: "ob-footer-side ob-footer-side--left" }, /* @__PURE__ */ React.createElement(
      NavBtn,
      {
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "ob-footer-center" }, /* @__PURE__ */ React.createElement("div", { className: "ob-footer-dots", style: { pointerEvents: "auto" } }, Array.from({ length: TOTAL_SLIDES }).map((_, i) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: i,
        onClick: () => goTo(i),
        style: {
          ...
          height: 6,
          borderRadius: 3,
          background: i === currentSlide ? accent : i < currentSlide ? "color-mix(in srgb, var(--ob-accent) 35%, transparent)" : obTheme === "light" ? "rgba(37,37,37,0.28)" : "rgba(255,255,255,0.15)",
    ...
    )))), /* @__PURE__ */ React.createElement("div", { className: "ob-footer-side ob-footer-side--right" }, /* @__PURE__ */ React.createElement(
      NavBtn,
      {
        onClick: () => {
          if (cur === 0) {
...
try {
  if (typeof React === "undefined" || typeof ReactDOM === "undefined") {
    ...
    if (root) {
      ReactDOM.createRoot(root).render(/* @__PURE__ */ React.createElement(Onboarding, { theme: "dark", onComplete: () => {
      } }));
    }
  }
} catch (e) {
