...
const CIRCADIAN_THEMES = {
  ...
  dawn: {
    dark: {
      ...
      accent: "#FF8C35",
      accentDim: "rgba(255,140,53,0.25)",
      accentGlow: "rgba(255,140,53,0.55)",
